                ...
                <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                    <div class="px-4 py-6">
                        <div class="flex items-start">
                            <svg class="flex-shrink-0 w-12 h-12 text-[#FFBB00]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                            <div class="ml-4">
                                <h4 class="text-4xl font-bold text-[#001b42]"><span class="contagem">559</span>+</h4>
                ...
                <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                    <div class="px-4 py-6">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h4 class="text-4xl font-bold text-[#001b42]"><span class="contagem">1157</span>+</h4>
                ...
                <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                    <div class="px-4 py-6">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h4 class="text-4xl font-bold text-[#001b42]"><span class="contagem">2450</span>+</h4>
                ...
                <div class="overflow-hidden bg-white border border-gray-200 rounded-lg">
                    <div class="px-4 py-6">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h4 class="text-4xl font-bold text-[#001b42]"><span class="contagem">98</span>%</h4>
